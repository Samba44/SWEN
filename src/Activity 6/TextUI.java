...
public class TextUI implements Observer {
    ...
    public void update(Observable obs, Object ignore) {
         ...
         */
        System.out.printf(
                "Reading is %6.2f degrees C, %6.2f degrees K, %6.2f degrees F, %6.2f inches of mercury and %6.2f milibars%n",
                station.getCelsius(), station.getKelvin(), station.getFahrenheit(), station.getInches(), station.getMilibars()) ;
    }
}
