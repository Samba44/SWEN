...
public class WeatherStation extends Observable implements Runnable {
   ...
   private final ITempSensor tSensor; // Temperature sensor.
   private final IBarometer barometer;  // Barometer sensor.
    ...
    * object it will use.
    */
   public WeatherStation(ITempSensor _tSensor, IBarometer _barometer) {
      tSensor = _tSensor;
      currentTempReading = tSensor.temp();
